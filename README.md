...
- Postman Collection:  
  - [Download Eventify.postman_collection.json](Eventify.postman_collection.json)  
...
|---|---|---|---|  
| **Sadik Rahman** | sadik.nai.008@gmail.com | [SadikRahman14](https://github.com/SadikRahman14) | Backend and System Design |  
| **Eusha Ahmed** | eushaahmed08@gmail.com | [eushaahmed08](https://github.com/eushaahmed08) | Frontend |  
| **Hasibur Rahman** | srijond57@gmail.com | [srijon57](https://github.com/srijon57) | UIUX and Frontend |  


### Class Diagram

This diagram represents the main classes and their relationships in the Eventify system.
...
ClubAdmin --> Event : manages

Student --> Event : registers
...
This diagram outlines the main use cases and actors in the Eventify system.
...
A[Student] -->|View Events| B(Event Listing)

A -->|Register for Event| C(Event Registration)

A -->|Unregister from Event| D(Event Unregistration)

A -->|View Dashboard| E(Student Dashboard)

F[Club Admin] -->|Create Event| G(Event Creation)

F -->|Edit Event| H(Event Editing)

F -->|Delete Event| I(Event Deletion)

F -->|View Attendees| J(Attendee List)

F -->|Manage Dashboard| K(Admin Dashboard)

L[University Staff] -->|Monitor Events| B
